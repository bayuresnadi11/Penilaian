...
<head>
    <meta charset="UTF-8">
    <title>Laporan Nilai Siswa - SMKN 11 Bandung</title>
    <style>
        body {
...
<body>
    ...
    <!-- Judul Laporan -->
    <h4>LAPORAN DATA NILAI SISWA<br>TAHUN AJARAN {{ now()->year }}/{{ now()->year + 1 }}</h4>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="7">Tidak ada data nilai tersedia.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
