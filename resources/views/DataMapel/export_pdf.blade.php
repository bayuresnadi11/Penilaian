...
<head>
    <meta charset="UTF-8">
    <title>Laporan Data Mata Pelajaran - SMKN 11 Bandung</title>
    <style>
        body {
...
<body>
    ...
    <!-- Judul Laporan -->
    <h4>LAPORAN DATA MATA PELAJARAN<br>TAHUN AJARAN {{ now()->year }}/{{ now()->year + 1 }}</h4>
    ...
    <table>
        ...
        @empty
            <tr>
                <td colspan="4">Tidak ada data mata pelajaran tersedia.</td>
            </tr>
        @endforelse
        </tbody>
    </table>
